...
- Illustrator exporter 0.6.6 exports only the active artboard, separates explicit lines and whitespace-delimited items inside a text frame for better translation matching, but keeps a same-size multi-line headline as one object. Tabular exports preserve tab anchors and give the final column a full neighboring column width. It skips expensive document-wide path, logo, and outlined-group scans, creates one SVG instead of two, reports progress, and supports cancellation.
